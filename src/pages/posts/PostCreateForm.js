...
// Renders the form to create a post, user will need to be signed in or they won't be allowed
// Will require a title, content/description and an image for the form to be submitted
